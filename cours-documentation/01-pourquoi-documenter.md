...
Photo de Kritzolina, 2018. Elle illustre l’activité du cas fictif Réserve ta place. [Source et licence](visuels/credits.md).
...
![Trois personnes cherchent une règle, une procédure ou un point d’entrée dans le code.](visuels/besoins.svg)
...
Vérifie cette réponse dans le [scénario exécutable](../demo/features/reservations.feature). Le [chapitre 9](09-documentation-vivante.md) explique comment faire travailler ensemble les lecteurs métier et les développeurs.
