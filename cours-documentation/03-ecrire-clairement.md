...
![Une consigne passe du contexte à l’action, au résultat attendu puis au dépannage.](visuels/consigne.svg)
...
Cette instruction donne un emplacement, un prérequis et un résultat observable. La procédure complète reste dans le [README du kit](../demo/README.md). Lorsque le nombre de tests change, relis aussi les pages qui l’annoncent.
