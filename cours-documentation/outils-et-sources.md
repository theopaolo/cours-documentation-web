...
Le [prolongement sur la documentation dans l’éditeur](documentation-editeur.md) fournit les exemples JavaScript et TypeScript, les raccourcis de survol et les commandes de génération TypeDoc. Ses outils optionnels sont séparés des dépendances du kit de base.
...
[Crédits de la capture](visuels/credits.md).
