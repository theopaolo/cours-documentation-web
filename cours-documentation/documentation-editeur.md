...
Les commentaires placés près du code peuvent alimenter l’aide au survol, l’assistance à la saisie et une référence publiée. Cette manipulation prolonge les chapitres [Décisions et code](07-decisions-et-code.md) et [Documentation vivante](09-documentation-vivante.md).
...
2. Ouvrir [demo/editeur/survol.js](../demo/editeur/survol.js).
3. Survoler le nom reserver dans l’appel. L’éditeur doit présenter la signature et la description issues du [fichier documenté](../demo/src/reservations.mjs).
...
<!-- inclure: demo/editeur/survol.js -->
...
Le [tsconfig de l’exercice](../demo/editeur/tsconfig.json) autorise l’analyse du JavaScript et n’émet pas de nouveaux fichiers. Il limite les fichiers d’entrée aux deux exemples. Les modules importés sont aussi lus pour connaître leurs signatures. Il ne lance pas une vérification exhaustive du kit.
...
<!-- inclure: demo/editeur/capacite.ts -->

[Fichier TypeScript complet](../demo/editeur/capacite.ts).
