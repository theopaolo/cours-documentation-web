...
Le [README de la démonstration](../demo/README.md) est un exemple complet : usage, périmètre, prérequis, commandes, résultats attendus et dépannage. Ouvre-le avec un collègue qui n’a pas préparé le dossier.

![Parcours de lancement du kit et vérification du résultat.](visuels/installation.svg)
