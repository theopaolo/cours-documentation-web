...
![Diátaxis distingue apprendre et travailler, puis agir et comprendre.](visuels/diataxis.svg)
...
La navigation du [site MkDocs](../mkdocs.yml) regroupe le cours, les manipulations et les ressources. Pour un produit réel, crée plutôt des entrées selon les tâches des lecteurs : réserver, gérer les ateliers, intégrer l’API, intervenir en cas d’incident.
