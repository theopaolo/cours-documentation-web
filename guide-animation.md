...
1. Pendant 45 minutes, lire les chapitres 1 à 4 et exécuter les deux commandes de base du [kit](demo/README.md). Faire expliquer le README par une autre personne.
...
Exécuter les commandes du README pour la référence JSDoc, le graphe des imports et le site. Montrer le [hook MkDocs](scripts/mkdocs_hook.py) et la page [Exemples](cours-documentation/exemples.md).
...
Pour la CI, lire le [workflow fourni](scripts/documentation-workflow.yml) de haut en bas. Demander ce qui bloque la construction et ce qui nécessite encore une relecture humaine. L’artefact doit correspondre à l’exécution et au commit examinés.
